...
import { OrderListRouteNameLabel } from "@/components/orders/OrderListRouteNameLabel";
...
interface Order {
    ...
    net_amount: number;
    is_returned: boolean;
    /** Optional BE list field. Display-only; never invent. */
                            ...
                            >
                                <TableCell className="font-medium">
                                    <div className="flex flex-col items-start leading-tight">
                                        ...
                                        <OrderListRouteNameLabel order={order} className="mt-1" />
                                    </div>
                                </TableCell>
                                <TableCell>
                    ...
                    >
                        <div className="flex justify-between items-start">
                            <div className="flex flex-col gap-1">
                                ...
                                <OrderListRouteNameLabel order={order} />
                            </div>
                            <div className="flex flex-col items-end">
