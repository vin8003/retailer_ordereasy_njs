...
import { SalesReturnCnNumberLabel } from "@/components/returns/SalesReturnCnNumberLabel";
import type { SalesReturnCnNumberDisplay } from "@/utils/salesReturnCnNumber";

export type SalesReturnListItem = SalesReturnCnNumberDisplay & {
    id: number;
...
/** Presentational sales-return list. `cn_number` is optional; blank stays hidden. */
                            ...
                            <tr key={item.id} className="border-b last:border-0 hover:bg-muted/40">
                                <td className="p-4 pl-6">
                                    <div className="flex flex-col">
                                        ...
                                        <SalesReturnCnNumberLabel salesReturn={item} className="mt-0.5" />
                                    </div>
                                </td>
