...
import { SalesReturnTransporterName } from '@/components/returns/SalesReturnTransporterName';
import type { SalesReturnTransporterDisplay } from '@/utils/salesReturnTransporter';
...
function SalesReturnDetailContent() {
    ...
    const [returnData, setReturnData] = useState<(SalesReturnTransporterDisplay & {
        id?: number;
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-primary/5 sticky top-8">
                        ...
                        <SalesReturnTransporterName salesReturn={returnData} className="mb-8" />
