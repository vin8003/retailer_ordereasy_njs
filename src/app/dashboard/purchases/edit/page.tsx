...
import { PurchaseDetailEwayBill } from '@/components/purchases/PurchaseDetailEwayBill';
import type { PurchaseDetailEwayBillDisplay } from '@/utils/purchaseDetailEwayBill';
...
function EditPurchaseContent() {
    ...
    const [invoiceFromBe, setInvoiceFromBe] = useState<PurchaseDetailEwayBillDisplay | null>(null);
