...
import { PurchaseDetailIrn } from '@/components/purchases/PurchaseDetailIrn';
import type { PurchaseDetailIrnDisplay } from '@/utils/purchaseDetailIrn';
...
function EditPurchaseContent() {
    ...
    const [invoiceFromBe, setInvoiceFromBe] = useState<PurchaseDetailIrnDisplay | null>(null);
